...
| 둘 다 | `lecture-material-digest` | 강의자료 파일 1개 이상을 순차 처리해 각 파일별 `<원본파일명>_ digest.md`를 생성하고, 용어는 English로 유지한 채 한국어로 주요 개념을 자세히 설명하는 이해 중심 다이제스트를 만듭니다. | `codex/skills/lecture-material-digest/SKILL.md` | `claude_code/skills/lecture-material-digest/SKILL.md` |
